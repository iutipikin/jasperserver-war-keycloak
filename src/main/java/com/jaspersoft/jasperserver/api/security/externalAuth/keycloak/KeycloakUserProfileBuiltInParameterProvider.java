...
//com.jaspersoft.jasperserver.api.security.externalAuth.keycloak.KeycloakUserProfileBuiltInParameterProvider
...
/**
 * Created by Yuri on 30.08.2017 at com.jaspersoft.jasperserver.api.security.externalAuth.keycloak.
 */
public class KeycloakUserProfileBuiltInParameterProvider implements BuiltInParameterProvider, Serializable {
    /*
    ...
    public KeycloakUserProfileBuiltInParameterProvider() {
        init();
    }
    ...
    protected MetadataUserDetails getUserDetails() {
        return new MetadataUserDetails((User) ProfileAttributeCategory.USER.getPrincipal(null));
//        return (MetadataUserDetails) ProfileAttributeCategory.USER.getPrincipal(null);
    ...
    protected Object[] makeParameter(String name, Class<?> type, Object value) {
        ...
        return new Object[]{makeParameter(name, type), value};
    }

    private static JRParameter makeParameter(String name, Class type) {
